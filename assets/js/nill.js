...
function colorScheme() {
    ...
    $('.color-scheme').click(function() {
        ...
        if ($(this).children().hasClass('lni-sun')) {
            $("#freevio-logo").attr("src", "./assets/img/logo-01.png");
            $("#estee-lauder-img").attr("src", "assets/img/portfolio/estee-lauder/thumbnail.png");
            $("#origins-img").attr("src", "assets/img/portfolio/origins/thumbnail.png");
            $("#huawei-pic").attr("src", "assets/img/portfolio/huawei/huawei-glow-1.png");
            $('.overlay-menu').css("background-color", "black");
            $('.menu-text').css("color", "white");
        } else {
            $("#freevio-logo").attr("src", "./assets/img/logo-02.png");
            $("#estee-lauder-img").attr("src", "assets/img/portfolio/estee-lauder/thumbnail-black.png");
            $("#origins-img").attr("src", "assets/img/portfolio/origins/thumbnail-black.png");
            $("#huawei-pic").attr("src", "assets/img/portfolio/huawei/thumbnail.png");
            $('.overlay-menu').css("background-color", "white");
