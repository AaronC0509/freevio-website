...
! function(l, o, e) { "use strict";
    l.fn.scrollUp = function(o) { l.data(e.body, "scrollUp") || (l.data(e.body, "scrollUp", !0), l.fn.scrollUp.init(o)) }, l.fn.scrollUp.init = function(r) { var s, t, c, i, n, a, d = l.fn.scrollUp.settings = l.extend({}, l.fn.scrollUp.defaults, r),
            p = !1; switch (a = d.scrollTrigger ? l(d.scrollTrigger) : l("<a/>", { id: d.scrollName, href: "#top" }), d.scrollTitle && a.attr("title", d.scrollTitle), a.appendTo("body"), d.scrollImg || d.scrollTrigger || a.html(d.scrollText), a.css({ display: "none", position: "fixed", zIndex: d.zIndex }), d.activeOverlay && l("<div/>", { id: d.scrollName + "-active" }).css({ position: "absolute", top: d.scrollDistance + "px", width: "100%", borderTop: "1px dotted" + d.activeOverlay, zIndex: d.zIndex }).appendTo("body"), d.animation) {
            case "fade":
                s = "fadeIn", t = "fadeOut", c = d.animationSpeed; break;
            case "slide":
                s = "slideDown", t = "slideUp", c = d.animationSpeed; break;
            default:
                s = "show", t = "hide", c = 0 }
...
! function(e, n, t, o) {
    ...
    e.fn.pagepiling = function(i) {
        ...
        e.extend(e.easing, { easeInQuart: function(e, n, t, o, i) { return o * (n /= i) * n * n * n + t } }), s.setScrollingSpeed = function(e) { m.scrollingSpeed = e }, s.setMouseWheelScrolling = function(e) { e ? c.get(0).addEventListener ? (c.get(0).addEventListener("mousewheel", k, !1), c.get(0).addEventListener("wheel", k, !1)) : c.get(0).attachEvent("onmousewheel", k) : c.get(0).addEventListener ? (c.get(0).removeEventListener("mousewheel", k, !1), c.get(0).removeEventListener("wheel", k, !1)) : c.get(0).detachEvent("onmousewheel", k) }, s.setAllowScrolling = function(e) {
        ...
        }()), e(c).css({ overflow: "hidden", "-ms-touch-action": "none", "touch-action": "none" }), s.setAllowScrolling(!0), e.isEmptyObject(m.navigation) || function() {
        ...
        function S(n, t) {
            var o, i = { destination: n, animated: t, activeSection: e(".pp-section.active"), anchorLink: n.data("anchor"), sectionIndex: n.index(".pp-section"), toMove: n, yMovement: (o = n, e(".pp-section.active").index(".pp-section") > o.index(".pp-section") ? "up" : "down"), leavingSection: e(".pp-section.active").index(".pp-section") + 1 };
            if (!i.activeSection.is(n)) {
                ...
                void 0 === i.animated && (i.animated = !0), void 0 !== i.anchorLink && (s = i.anchorLink, c = i.sectionIndex, m.anchors.length ? (location.hash = s, M(location.hash)) : M(String(c))), i.destination.addClass("active").siblings().removeClass("active"), i.sectionsToMove = function(n) {
                        var t;
                        t = "down" === n.yMovement ? e(".pp-section").map(function(t) { if (t < n.destination.index(".pp-section")) return e(this) }) : e(".pp-section").map(function(t) { if (t > n.destination.index(".pp-section")) return e(this) });
                        return t
                    }(i), "down" === i.yMovement ? (i.translate3d = q(), i.scrolling = "-100%", m.css3 || i.sectionsToMove.each(function(n) { n != i.activeSection.index(".pp-section") && e(this).css(x(i.scrolling)) }), i.animateSection = i.activeSection) : (i.translate3d = "translate3d(0px, 0px, 0px)", i.scrolling = "0", i.animateSection = n), e.isFunction(m.onLeave) && m.onLeave.call(this, i.leavingSection, i.sectionIndex + 1, i.yMovement),
                    function(n) { m.css3 ? (T(n.animateSection, n.translate3d, n.animated), n.sectionsToMove.each(function() { T(e(this), n.translate3d, n.animated) }), setTimeout(function() { w(n) }, m.scrollingSpeed)) : (n.scrollOptions = x(n.scrolling), n.animated ? n.animateSection.animate(n.scrollOptions, m.scrollingSpeed, m.easing, function() { b(n), w(n) }) : (n.animateSection.css(x(n.scrolling)), setTimeout(function() { b(n), w(n) }, 400))) }(i), l = i.anchorLink, m.menu && (e(m.menu).find(".active").removeClass("active"), e(m.menu).find('[data-menuanchor="' + l + '"]').addClass("active")),
                    function(n, t) { m.navigation && (e("#pp-nav").find(".active").removeClass("active"), n ? e("#pp-nav").find('a[href="#' + n + '"]').addClass("active") : e("#pp-nav").find("li").eq(t).find("a").addClass("active")) }(i.anchorLink, i.sectionIndex), a = i.anchorLink;
                var p = (new Date).getTime();
                r = p
            }
        }

        function w(n) { e.isFunction(m.afterLoad) && m.afterLoad.call(this, n.anchorLink, n.sectionIndex + 1) }

        function b(n) { "up" === n.yMovement && n.sectionsToMove.each(function(t) { e(this).css(x(n.scrolling)) }) }

        function x(e) { return "vertical" === m.direction ? { top: e } : { left: e } }

        function M(n) { n = n.replace("#", ""), e("body")[0].className = e("body")[0].className.replace(/\b\s?pp-viewing-[^\s]+\b/g, ""), e("body").addClass("pp-viewing-" + n) }

        function y() { return (new Date).getTime() - r < f + m.scrollingSpeed }

        function T(e, n, t) { e.toggleClass("pp-easing", t), e.css(function(e) { return { "-webkit-transform": e, "-moz-transform": e, "-ms-transform": e, transform: e } }(n)) }
        e(".pp-section").each(function(n) { e(this).data("data-index", n), e(this).css("z-index", g), n || 0 !== e(".pp-section.active").length || e(this).addClass("active"), void 0 !== m.anchors[n] && e(this).attr("data-anchor", m.anchors[n]), void 0 !== m.sectionsColor[n] && e(this).css("background-color", m.sectionsColor[n]), m.verticalCentered && !e(this).hasClass("pp-scrollable") && e(this).addClass("pp-table").wrapInner('<div class="pp-tableCell" style="height:100%" />'), g -= 1 }).promise().done(function() {
        ...
        }), e(t).on("hashchange", function() { var o = t.location.hash.replace("#", "").split("/")[0]; if (o.length) { if (o && o !== a) S(isNaN(o) ? e(n).find('[data-anchor="' + o + '"]') : e(".pp-section").eq(o - 1)) } }), e(n).keydown(function(n) {
        ...
        }), m.normalScrollElements && (e(n).on("mouseenter", m.normalScrollElements, function() { s.setMouseWheelScrolling(!1) }), e(n).on("mouseleave", m.normalScrollElements, function() { s.setMouseWheelScrolling(!0) }));
        ...
        function k(n) {
            ...
            var r = o - C;
            if (C = o, r > 200 && (u = []), !y()) { var l = D(e(".pp-section.active")); return E(u, 10) >= E(u, 70) && c && (a < 0 ? L("down", l) : a > 0 && L("up", l)), !1 }
        }

        function E(e, n) { for (var t = 0, o = e.slice(Math.max(e.length - n, 1)), i = 0; i < o.length; i++) t += o[i]; return Math.ceil(t / n) }

        function L(e, n) {
            var t, o;
            if ("down" == e ? (t = "bottom", o = s.moveSectionDown) : (t = "top", o = s.moveSectionUp), n.length > 0) {
                if (! function(e, n) { if ("top" === e) return !n.scrollTop(); if ("bottom" === e) return n.scrollTop() + 1 + n.innerHeight() >= n[0].scrollHeight }(t, n)) return !0;
                o()
            } else o()
        }

        function D(e) { return e.filter(".pp-scrollable") }

        function I() { return t.PointerEvent ? { down: "pointerdown", move: "pointermove", up: "pointerup" } : { down: "MSPointerDown", move: "MSPointerMove", up: "MSPointerUp" } }

        function X(e) { var n = new Array; return n.y = void 0 !== e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, n.x = void 0 !== e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, n }

        function P(e) { return void 0 === e.pointerType || "mouse" != e.pointerType }
        ...
        function N(n) {
            ...
            if (! function n(t, o) { o = o || 0; var i = e(t).parent(); return !!(o < m.normalScrollElementTouchThreshold && i.is(m.normalScrollElements)) || o != m.normalScrollElementTouchThreshold && n(i, ++o) }(n.target) && P(t)) {
        ...
        function q() { return "vertical" !== m.direction ? "translate3d(-100%, 0px, 0px)" : "translate3d(0px, -100%, 0px)" }
        e(n).on("click touchstart", "#pp-nav a", function(n) {
            ...
            mouseleave: function() { e(this).find(".pp-tooltip").fadeOut(200, function() { e(this).remove() }) }
        }, "#pp-nav li")
    }
...
! function(t, e) { "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.Typed = e() : t.Typed = e() }(this, function() {
    return function(t) {
        ...
        function s(n) { if (e[n]) return e[n].exports; var i = e[n] = { exports: {}, id: n, loaded: !1 }; return t[n].call(i.exports, i, i.exports, s), i.loaded = !0, i.exports }
        ...
        var i = s(1),
            r = s(3),
            o = function() {
                function t(e, s) {! function(t, e) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") }(this, t), i.initializer.load(this, s, e), this.begin() }
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 });
        var n = Object.assign || function(t) { for (var e = 1; e < arguments.length; e++) { var s = arguments[e]; for (var n in s) Object.prototype.hasOwnProperty.call(s, n) && (t[n] = s[n]) } return t },
            i = function() {
                function t(t, e) {
                    for (var s = 0; s < e.length; s++) {
                        var n = e[s];
            ...
            u = function() {
                ...
                return i(t, [{
                    ...
                    value: function(t, e, s) {
                        ...
                        for (var o in t.strPos = 0, t.arrayPos = 0, t.stopNum = 0, t.loop = t.options.loop, t.loopCount = t.options.loopCount, t.curLoop = 0, t.shuffle = t.options.shuffle, t.sequence = [], t.pause = { status: !1, typewrite: !0, curString: "", curStrPos: 0 }, t.typingComplete = !1, t.strings) t.sequence[o] = o;
